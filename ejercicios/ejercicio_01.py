# Ejercicio 1:Uso de la función print() para Python.

# Descripción:
# Este ejercicio te ayudará a emplear la función más básica en Python pero también una de las más populares: imprimir mensajes en consola.
