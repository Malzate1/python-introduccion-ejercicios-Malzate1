# Ejercicio 09: Cálculo de promedio de una lista con "len ()".

# Descripción: Con la ayuda de la herramienta len() sumaremos el total de elementos en una lista para posteriormente realizar la divisíon de los mismos y obtener el promedio.
...
# Tip: Recuerda imprimir el resultado antes de ejecutar el script.
#      Para redondear el decimal del resultado del promedio, imprime el resultado dentro de la funcion print() acompañado de la expresión .2f al imprimir el resultado así:{promedio:.2f}.
